...
#line 1127 "y.tab.c"
  ...
  case 6: /* expression: expression '*' NUMBER  */
...
#line 16 "Calculator.y"
                        { if (yyvsp[0]!=0){ yyval = yyvsp[-2]/yyvsp[0]; }else { printf("Error: divide by Zero"); } }
#line 1139 "y.tab.c"
    break;
